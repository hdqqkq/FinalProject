...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head id="Head1">
  ...
  <script type="text/javascript">
	 ...
	 var _menus = {
		                 "menus":[
						           {"menuid":"1","icon":"icon-sys","menuname":"操作选项",
							      "menus":[
									{"menuid":"12","menuname":"登陆","icon":"icon-page","url":"login"},
									{"menuid":"13","menuname":"教授","icon":"icon-class","url":"professor"},
									{"menuid":"14","menuname":"管理员","icon":"icon-role","url":"admin"},
									{"menuid":"15","menuname":"教授管理","icon":"icon-set","url":"professorManage"},
									{"menuid":"16","menuname":"学生","icon":"icon-log","url":"student"}
								    ]},
