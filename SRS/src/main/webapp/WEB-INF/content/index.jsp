...
<head id="Head1">
    ...
    <script type="text/javascript">
	 ...
	 var _menus = {
		                 "menus":[
						           {"menuid":"1","icon":"icon-sys","menuname":"学生",
							      "menus":[
									{"menuid":"12","menuname":"学生登录","icon":"icon-page","url":"login"},									
								    ]},
						{"menuid":"8","icon":"icon-sys","menuname":"管理员",
							"menus":[{"menuid":"21","menuname":"管理员登陆","icon":"icon-page","url":"login"},
									{"menuid":"22","menuname":"添加排课信息","icon":"icon-nav","url":"addSection"}
								]
						},{"menuid":"56","icon":"icon-sys","menuname":"教授",
							"menus":[{"menuid":"31","menuname":"教授登陆","icon":"icon-nav","url":"login"},
									{"menuid":"32","menuname":"教授管理","icon":"icon-nav","url":"professorManage"}
								]
						},
				]};
        //设置登录窗口
